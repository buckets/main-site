...
export const DEFAULTS:IMessages = {
  "Reopen Account": {
    val: "Reopen Account",
    translated: false,
    src: ["src/budget/accounts.tsx line 31","src/budget/accounts.tsx line 152"],
    h: "KBv9ohpTpLSanhr/AFbKdJCA0VZ1iJ0THB53Hut00v4=",
  },
  "Reopen": {
    val: "Reopen",
    translated: false,
    src: ["src/budget/accounts.tsx line 33","src/budget/accounts.tsx line 154"],
    h: "5497b4yxPFO2M524tL0qmmNk47Qv/aca/7n0zMEeX/o=",
  },
  "You have no closed accounts.": {
    val: "You have no closed accounts.",
    translated: false,
    src: ["src/budget/accounts.tsx line 41"],
    h: "8BZG+UdW1Rrd/+2zFNv7SskiNpD6DtlNa8LwQulqX5s=",
  },
  "Account": {
    val: "Account",
    translated: false,
    src: ["src/budget/accounts.tsx line 48","src/budget/accounts.tsx line 103","src/budget/importpage.tsx line 455","src/budget/searchpage.tsx line 119","src/budget/searchpage.tsx line 143","src/budget/transactions.tsx line 221"],
  ...
  "accounts.balance_mismatch_msg": {
    ...
    translated: false,
    src: ["src/budget/accounts.tsx line 81"],
    h: "8xHas2SyXqC7roWhYQNIVhFVNvbvzMi6Y3mQce5sIbc=",
  },
  "accounts.name_placeholder": {
    val: "no name",
    translated: false,
    src: ["src/budget/accounts.tsx line 88","src/budget/accounts.tsx line 276"],
    h: "UwMHboI9q49SZQkwMN8ps9zBi6YOSdtwakjLJwudtyA=",
  },
  "Update Account Name": {
    val: "Update Account Name",
    translated: false,
    src: ["src/budget/accounts.tsx line 91","src/budget/accounts.tsx line 279"],
    h: "xcyLhnHNOTDgJsYGhaelbAmXYam4HWMfD5mQiTiZJ50=",
  },
  "Balance": {
    val: "Balance",
    translated: false,
    src: ["src/budget/accounts.tsx line 104","src/budget/accounts.tsx line 288","src/budget/buckets.tsx line 820","src/budget/buckets.tsx line 1241","src/budget/transactions.tsx line 224"],
    h: "azvDWgVPY349dq4q8mbtpDhehRsFKYKNzMk/TcuOvEQ=",
  },
  "single-account Closed": {
    val: "Closed",
    translated: false,
    src: ["src/budget/accounts.tsx line 155"],
  ...
  "Permanently delete account": {
    ...
    translated: false,
    src: ["src/budget/accounts.tsx line 165"],
    h: "fcpAc/TcJr/ayfOjnYZmGo2BIga/mx8UyuwCbh2BRFg=",
  },
  "Close Account": {
    val: "Close Account",
    translated: false,
    src: ["src/budget/accounts.tsx line 171"],
  ...
  "Account closed": {
    val: "Account closed",
    translated: false,
    src: ["src/budget/accounts.tsx line 178"],
    h: "l9xs5wLKF3KIgunL1SJh9r9XDYpWkC7LYrL4KUUFm3M=",
  },
  "Close account": {
    val: "Close account",
    translated: false,
    src: ["src/budget/accounts.tsx line 181"],
    h: "7HdV8X8++teDNW33urE2eccDw3VLdSpvII89zC/sfu4=",
  },
  "Synced balance": {
    val: "Synced balance",
    translated: false,
    src: ["src/budget/accounts.tsx line 186"],
  ...
  "getting-started-link": {
    ...
    translated: false,
    src: ["src/budget/accounts.tsx line 363"],
    h: "9NGQRvIxlAaOF9i+zWPXMFQubcY+5jtA7Td/lii16aM=",
  },
  "New account": {
    val: "New account",
    translated: false,
    src: ["src/budget/accounts.tsx line 374"],
    h: "MtAiANg7ugdeUiGmiGklfBPG4T1igh1iChKeC0Mdxnc=",
  },
  "Connect to bank": {
    val: "Connect to bank",
    translated: false,
    src: ["src/budget/accounts.tsx line 375"],
  ...
  "sync.toast.syncing": {
    ...
    translated: false,
    src: ["src/budget/appstate.ts line 355"],
    h: "f7R9zSdK0q5+lZ8I9QRhiwN5ENKyWFnrmUG6Gltegfs=",
  },
  "Sync complete": {
    val: "Sync complete",
    translated: false,
    src: ["src/budget/appstate.ts line 373"],
    h: "e2VXpLTi1mhVSVqDkExwdM5j8PhfW0MHeOqBwabU4Zo=",
  },
  "Account created: ": {
    val: "Account created: ",
    translated: false,
    src: ["src/budget/appstate.ts line 419"],
    h: "AJEfsK8U+n7xnyBkG2FG3cmZZipr4kpQX5mgCZ0Qwi4=",
  },
  "Unknown account: ": {
    val: "Unknown account: ",
    translated: false,
    src: ["src/budget/appstate.ts line 478"],
    h: "1pPv2ePlW/PBrqgYgGCM3lU9qnmnbplR3AzSDDG4TLs=",
  },
  "Un-kick Bucket": {
    val: "Un-kick Bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 50","src/budget/buckets.tsx line 1060"],
    h: "7WOQPepkeOH+dwwSbEjomy0amoqY5JtvtlyCSG02c1Q=",
  },
  "Un-kick": {
    val: "Un-kick",
    translated: false,
    src: ["src/budget/buckets.tsx line 52","src/budget/buckets.tsx line 1062"],
  ...
  "You haven't kicked the bucket yet...": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 60"],
    h: "mtaAsLJ7BgWZcbIkRmZ4ZPSSRGXj6vJ2H8+diLhIba4=",
  },
  "Bucket": {
    val: "Bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 67","src/budget/reports.tsx line 604","src/budget/searchpage.tsx line 96","src/budget/searchpage.tsx line 172"],
    h: "APPSgbsmF5H9B7YIJDaPcEVh4T7ctWU+hxQv/eG1Dg0=",
  },
  "In": {
    val: "In",
    translated: false,
    src: ["src/budget/buckets.tsx line 106","src/budget/buckets.tsx line 823"],
    h: "TcCPpYF7/U7vM5pPmpqvJipZt0WPk3A/vC7Ec8pfDvo=",
  },
  "Out": {
    val: "Out",
    translated: false,
    src: ["src/budget/buckets.tsx line 112"],
    h: "v4Oj0CQx7cmHP4mcJsZX4xMTzMzeFS81XA9gU3qOFKU=",
  },
  "Net": {
    val: "Net",
    translated: false,
    src: ["src/budget/buckets.tsx line 124"],
  ...
  "Rain left": {
    val: "Rain left",
    translated: false,
    src: ["src/budget/buckets.tsx line 132"],
    h: "+xrBpD9ex3fqQgh+YuNxsFxWyrbE8G1236f81k2whuY=",
  },
  "Make it so": {
    val: "Make it so",
    translated: false,
    src: ["src/budget/buckets.tsx line 144","src/budget/buckets.tsx line 147","src/budget/buckets.tsx line 150"],
  ...
  "Warning: Doing this will use rain you don't have and could steal rain from future months (if available).": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 145"],
    h: "YR+S0SMnFz4+K5vpXrMzMfSaBE5mHBrhQTalzgI0/7U=",
  },
  "Self debt": {
    val: "Self debt",
    translated: false,
    src: ["src/budget/buckets.tsx line 172"],
  ...
  "action.New group": {
    val: "New group",
    translated: false,
    src: ["src/budget/buckets.tsx line 215"],
    h: "054RU7JImk6Pavh27xHA9CgGIgjmP0dYIgXez2UWx34=",
  },
  "Rain": {
    val: "Rain",
    translated: false,
    src: ["src/budget/buckets.tsx line 218","src/budget/budget.tsx line 225","src/budget/budget.tsx line 248"],
  ...
  "Total amount your buckets expect each month.": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 218"],
    h: "UtK2gxh+N9D/p1G6dLyhcKMP5Df5XCyEp0jM0c+qoUw=",
  },
  "New Bucket": {
    val: "New Bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 250","src/budget/buckets.tsx line 897"],
    h: "FchHrB6weykpHiqRVxc5QKb6BEdhH4DXrc+t6RNcF8M=",
  },
  "default new bucket name": {
    val: "New Bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 251","src/budget/buckets.tsx line 898"],
    h: "FchHrB6weykpHiqRVxc5QKb6BEdhH4DXrc+t6RNcF8M=",
  },
  "New Group": {
    val: "New Group",
  ...
  "Transactions": {
    val: "Transactions",
    translated: false,
    src: ["src/budget/buckets.tsx line 295","src/budget/budget.tsx line 166","src/budget/exportpage.tsx line 148"],
    h: "4+yGUer/b71cfxTdeUa5QbonqN9ezC8Eii7KO22Ety0=",
  },
  "Goal:": {
    val: "Goal:",
    translated: false,
    src: ["src/budget/buckets.tsx line 376"],
    h: "77+E2dn/Mw53xjGhNc6irsiq1WULAiC4yIyt4NaO0DM=",
  },
  "Update Goal": {
    val: "Update Goal",
    translated: false,
    src: ["src/budget/buckets.tsx line 384"],
  ...
  "buckettype.deposit": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 449"],
  ...
  "Goal completion:": {
    val: "Goal completion:",
    translated: false,
    src: ["src/budget/buckets.tsx line 465"],
  ...
  "Transaction": {
    val: "Transaction",
    translated: false,
    src: ["src/budget/buckets.tsx line 572"],
    h: "G0gRZS6Zq1VoQqtY+L8fY3ogdqSl/OAoTurOZ4L480Q=",
  },
  "Update Color": {
    val: "Update Color",
    translated: false,
    src: ["src/budget/buckets.tsx line 639","src/budget/buckets.tsx line 1116"],
    h: "6QBa9YrDFsWCiiS/PMj7r+cTmIgMmmqjTnv9x4l90ic=",
  },
  "Update Bucket Name": {
    val: "Update Bucket Name",
    translated: false,
    src: ["src/budget/buckets.tsx line 652"],
    h: "Oa+1EZtc4RTtPYyk5LflMMlQq/esZ3qvTgbSLiKIl4E=",
  },
  "Move Bucket": {
    val: "Move Bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 733","src/budget/buckets.tsx line 930"],
    h: "6lJYNJMplvVHQuXlFYBD81+4kgQQb1SwZ0s13hvlIfI=",
  },
  "In/Out": {
    val: "In/Out",
    translated: false,
    src: ["src/budget/buckets.tsx line 821"],
  ...
  "Want": {
    val: "Want",
    translated: false,
    src: ["src/budget/buckets.tsx line 822"],
  ...
  "buckethead.in": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 823"],
    h: "VaDlj3R8L2TD4QFh1rotfK5RjV7WF91mP3iqVAvdppc=",
  },
  "Activity": {
    val: "Activity",
    translated: false,
    src: ["src/budget/buckets.tsx line 824"],
  ...
  "bucket.detailslabel": {
    val: "Details",
    translated: false,
    src: ["src/budget/buckets.tsx line 825"],
    h: "68e/QPEuI36iIEcTWmKDrVU9KBReQ3EjFzF1F06KQMA=",
  },
  "New bucket": {
    val: "New bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 850"],
    h: "aIKjDQtVbUMjIHU/6fccfiWBUIwUBnAofdzRJTCuytI=",
  },
  ...
  "Kick Bucket": {
    val: "Kick Bucket",
    translated: false,
    src: ["src/budget/buckets.tsx line 1068"],
  ...
  "Update Name": {
    val: "Update Name",
    translated: false,
    src: ["src/budget/buckets.tsx line 1124"],
    h: "fTqm8NUcvzaYHnGFDmVhLePEd/TFNPhUDzSYIIerjNc=",
  },
  "Balance:": {
    val: "Balance:",
    translated: false,
    src: ["src/budget/buckets.tsx line 1129"],
  ...
  "Make Transfer": {
    val: "Make Transfer",
    translated: false,
    src: ["src/budget/buckets.tsx line 1202"],
  ...
  "Delete Transactions": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 1225","src/budget/transactions.tsx line 207"],
    h: "5rAWRNk97CWy9OfDP5IWSE/T2Ao461w7C3z/IDV154I=",
  },
  "Posted": {
    val: "Posted",
    translated: false,
    src: ["src/budget/buckets.tsx line 1238","src/budget/searchpage.tsx line 142","src/budget/searchpage.tsx line 171","src/budget/transactions.tsx line 220","src/csvimport.tsx line 507"],
    h: "h6jjM8ytGdEj+QfDnTVzEdq+0oLSE9zd+MArY7gtjzU=",
  },
  "Memo": {
    val: "Memo",
    translated: false,
    src: ["src/budget/buckets.tsx line 1239","src/budget/searchpage.tsx line 144","src/budget/searchpage.tsx line 173","src/budget/transactions.tsx line 222","src/csvimport.tsx line 337","src/csvimport.tsx line 508"],
    h: "9yClwoAwAV0+DXl8NnkkAnlUi+Ebp2soPwN5meYKgWY=",
  },
  "Amount": {
    val: "Amount",
    translated: false,
    src: ["src/budget/buckets.tsx line 1240","src/budget/searchpage.tsx line 145","src/budget/searchpage.tsx line 174","src/budget/transactions.tsx line 223","src/csvimport.tsx line 336","src/csvimport.tsx line 509"],
    h: "DHNNaJF4hWTWIFdaMdMhUT4aSdti7ZfaNexABzxWWzc=",
  },
  "noun.transfer": {
    val: "Transfer",
    translated: false,
    src: ["src/budget/buckets.tsx line 1242","src/budget/transactions.tsx line 953"],
  ...
  "bucket.transfer.help": {
    ...
    translated: false,
    src: ["src/budget/buckets.tsx line 1242"],
  ...
  "Trial Version": {
    val: "Trial Version",
    translated: false,
    src: ["src/budget/budget.tsx line 134","src/mainprocess/menu.ts line 292"],
    h: "GtZIXrHILA84HlpKlxi3BErHwR7WIYkQ/e5BE0Fiaxg=",
  },
  "Accounts": {
    val: "Accounts",
    translated: false,
    src: ["src/budget/budget.tsx line 162","src/budget/budget.tsx line 229","src/budget/searchpage.tsx line 115"],
  ...
  "Buckets": {
    val: "Buckets",
    translated: false,
    src: ["src/budget/budget.tsx line 167","src/budget/budget.tsx line 234","src/budget/searchpage.tsx line 92"],
    h: "fMPIWzGvVEG0t7+bZX1ucgzulk8FaQfqioLgwLsj+oE=",
  },
  "Kicked": {
    val: "Kicked",
    translated: false,
    src: ["src/budget/budget.tsx line 169"],
    h: "cWApfoLlcBvoHizIFtrDQq3uwrZIYMXKO1iLMvv8szI=",
  },
  "Analysis": {
    val: "Analysis",
    translated: false,
    src: ["src/budget/budget.tsx line 171"],
    h: "+LNAOPSLW2rpFCrT+U1suhdnoYyZa1k8ALddRlddDlI=",
  },
  "Recurring Expenses": {
    val: "Recurring Expenses",
    translated: false,
    src: ["src/budget/budget.tsx line 174","src/budget/reports.tsx line 600"],
  ...
  "Tools": {
    val: "Tools",
    translated: false,
    src: ["src/budget/budget.tsx line 178"],
    h: "mPsch0seV0ZNaU+41My/wS+DkAGfYqzWpPlJpfT1sBs=",
  },
  "Search": {
    val: "Search",
    translated: false,
    src: ["src/budget/budget.tsx line 181"],
    h: "vembE+Cp1aKCKR2j2LCJD29QyiQxfGPUcGI1I8l5/5Y=",
  },
  "Export": {
    val: "Export",
    translated: false,
    src: ["src/budget/budget.tsx line 182","src/budget/exportpage.tsx line 98"],
    h: "mZJs0iE089tMZ5BWqTUBp+2aJ90wKL4act4hUPt7zkA=",
  },
  "Chat with Matt": {
    val: "Chat with Matt",
    translated: false,
    src: ["src/budget/budget.tsx line 188"],
  ...
  "rain.help.pos": {
    ...
    translated: false,
    src: ["src/budget/budget.tsx line 255"],
  ...
  "rain.help.neg": {
    ...
    translated: false,
    src: ["src/budget/budget.tsx line 260"],
    h: "tqXmJxZXqyA0mN/8ugZkpCyspyO7XlPnGlEYGWgQ7jk=",
  },
  "Income": {
    val: "Income",
    translated: false,
    src: ["src/budget/budget.tsx line 275","src/budget/reports.tsx line 208","src/budget/transactions.tsx line 742"],
    h: "D2fJbta5d1Z5QYuRC5zzkBHsItZOOgY4FKrFJ64BvRs=",
  },
  "Expenses": {
    val: "Expenses",
    translated: false,
    src: ["src/budget/budget.tsx line 280","src/budget/reports.tsx line 219"],
  ...
  "months gain/loss label": {
    ...
    translated: false,
    src: ["src/budget/budget.tsx line 285"],
    h: "lGcEnJfZJau2h5ohbKNxY1FjL0vJoW3oJOJQwSCt+Kg=",
  },
  "in the bank": {
    val: "in the bank",
    translated: false,
    src: ["src/budget/budget.tsx line 291"],
  ...
  "Connection saved!": {
    ...
    translated: false,
    src: ["src/budget/importpage.tsx line 310"],
    h: "wAgyeIQsbaI/kFPgBf8sWlKK1mf/VcP7BjHpC9TNYuc=",
  },
  "On": {
    val: "On",
    translated: false,
    src: ["src/budget/importpage.tsx line 325"],
  ...
  "Enable Macro": {
    val: "Enable Macro",
    translated: false,
    src: ["src/budget/importpage.tsx line 356"],
  ...
  "Amazon.com Reconciliation": {
    ...
    translated: false,
    src: ["src/budget/tools/amazon.tsx line 226","src/budget/tools/toolspage.tsx line 29"],
    h: "SS/vhEAqfP5cTcprv5/4dDYZCEsTIMySGfXEngOoMj0=",
  },
  "Create Backup": {
    val: "Create Backup",
    translated: false,
    src: ["src/budget/tools/startover.tsx line 29"],
    h: "tUZEq5sa8Ggh6lIgsWzX8Blj6/unJ8dhl9sKpfwxRYY=",
  },
  "budget-file-type-name": {
    val: "Buckets Budget",
    translated: false,
    src: ["src/budget/tools/startover.tsx line 33","src/mainprocess/files.ts line 738"],
    h: "g2jeytcuhPOlEo6R2OlTzT3vNdE7sVWGnXuffEioq4c=",
  },
  "You must backup to a different file.": {
    val: "You must backup to a different file.",
    translated: false,
    src: ["src/budget/tools/startover.tsx line 42"],
  ...
  "Start Over": {
    val: "Start Over",
    translated: false,
    src: ["src/budget/tools/startover.tsx line 111","src/budget/tools/toolspage.tsx line 30"],
  ...
  "Keep buckets": {
    val: "Keep buckets",
    translated: false,
    src: ["src/budget/tools/startover.tsx line 116"],
  ...
  "Import file": {
    val: "Import file",
    translated: false,
    src: ["src/budget/tools/ynabimport.tsx line 69","src/budget/transactions.tsx line 119"],
  ...
  "Show uncategorized": {
    ...
    translated: false,
    src: ["src/budget/transactions.tsx line 110"],
  ...
  "transfer-from-account": {
    ...
    translated: false,
    src: ["src/budget/transactions.tsx line 505"],
  ...
  "transfer-to-account": {
    ...
    translated: false,
    src: ["src/budget/transactions.tsx line 510"],
    h: "Bd1IGkjXo2ruWofGrT+WwLdiy8IwJ/PW+7SO4TaDcps=",
  },
  "Transfer": {
    val: "Transfer",
    translated: false,
    src: ["src/budget/transactions.tsx line 739"],
    h: "B5GGqjnE8KOjYJjhsFV7zs5TGmGmVPqjihzMVxHJ3sI=",
  },
  "Categorization": {
    val: "Categorization",
    translated: false,
    src: ["src/budget/transactions.tsx line 896","src/budget/transactions.tsx line 906"],
    h: "DShuYOF3daz37AE7lGCN1TajYU1VyorRCvLwh4bM1r8=",
  },
  "Remove Categorization": {
    val: "Remove Categorization",
    translated: false,
    src: ["src/budget/transactions.tsx line 901"],
    h: "b5sIQMfXAnBAqHD2NJfIgIAxclRGe5LJ7NzzF6sOruQ=",
  },
  "Cancel": {
    val: "Cancel",
    translated: false,
    src: ["src/budget/transactions.tsx line 936"],
    h: "wHdMGFBg/BNmqwwBSIr4TrXk4fT1kilDHgZN5z4N5sU=",
  },
  "Save": {
    val: "Save",
    translated: false,
    src: ["src/budget/transactions.tsx line 937","src/wwwroot/record/record.tsx line 487"],
    h: "wduD0WXtkIpIb6B4R8AA7ph724u3/Gtv27uaky6rEAU=",
  },
  "noin.income": {
    val: "Income",
    translated: false,
    src: ["src/budget/transactions.tsx line 948"],
    h: "D2fJbta5d1Z5QYuRC5zzkBHsItZOOgY4FKrFJ64BvRs=",
  },
  "Categorize": {
    val: "Categorize",
    translated: false,
    src: ["src/budget/transactions.tsx line 976"],
  ...
  "Error": {
    val: "Error",
    translated: false,
    src: ["src/errors.ts line 121","src/errors.ts line 145"],
  ...
  "action.report bug": {
    val: "Report Bug",
    translated: false,
    src: ["src/errors.ts line 126"],
    h: "RxuE9Dh0Dadda2PtjUPD0dQ7b8aQok84Ytvw31ABBRU=",
  },
  "OK": {
    val: "OK",
    translated: false,
    src: ["src/errors.ts line 147"],
  ...
  "Buckets License": {
    val: "Buckets License",
    translated: false,
    src: ["src/mainprocess/dbstore.ts line 34","src/mainprocess/dbstore.ts line 68"],
...
Would you like to purchase a license now?`,
  ...
  "Later": {
    val: "Later",
    translated: false,
    src: ["src/mainprocess/drm.ts line 93","src/mainprocess/updater.ts line 195"],
  ...
  "Minimize": {
    val: "Minimize",
    translated: false,
    src: ["src/mainprocess/menu.ts line 194","src/mainprocess/menu.ts line 396"],
    h: "ELhkWGGY5oNKpfCzoXXW6TgkfS1nI0ZuJbWyYLmT+ro=",
  },
  "Close Window": {
    val: "Close Window",
    translated: false,
    src: ["src/mainprocess/menu.ts line 198","src/mainprocess/menu.ts line 392"],
  ...
  "Getting Started...": {
    val: "Getting Started...",
    translated: false,
    src: ["src/mainprocess/menu.ts line 249"],
    h: "XD8GQYEIDrNjTMPX4TjGeAbbCIEBcAONlYPd/D8Hz84=",
  },
  "Buckets Guide": {
    val: "Buckets Guide",
    translated: false,
    src: ["src/mainprocess/menu.ts line 256"],
    h: "iK/jSwFsIOO0YBANlaqC8+gTWFX+9IBYpc+HuiQ2U/c=",
  },
  "Chat...": {
    val: "Chat...",
    translated: false,
    src: ["src/mainprocess/menu.ts line 263"],
    h: "SytGirG0+cdtbPfjBma/G/tEOt4rdOj4mnjcaWsTbt8=",
  },
  "Show Log Files...": {
    val: "Show Log Files...",
    translated: false,
    src: ["src/mainprocess/menu.ts line 269"],
    h: "In00T9z1A4xO6nLu8zAU5s3UzH3+IcK4XjRvrT9CGMs=",
  },
  "Report Bug...": {
    val: "Report Bug...",
    translated: false,
    src: ["src/mainprocess/menu.ts line 275"],
  ...
  "It says:": {
    val: "It says:",
    translated: false,
    src: ["src/mainprocess/menu.ts line 284"],
  ...
  "Enter License...": {
    val: "Enter License...",
    translated: false,
    src: ["src/mainprocess/menu.ts line 301"],
  ...
  "Check For Updates...": {
    ...
    translated: false,
    src: ["src/mainprocess/menu.ts line 324"],
    h: "S/1p0syaOMqjAbHpmZa6gWaIh/9e29QR2cRJhiMadz0=",
  },
  "Preferences...": {
    val: "Preferences...",
    translated: false,
    src: ["src/mainprocess/menu.ts line 330"],
  ...
  "Services": {
    val: "Services",
    translated: false,
    src: ["src/mainprocess/menu.ts line 354"],
    h: "Y5+GuNZXfFSynDsHvAY8cr0RqU+moaHZNmOk2eQrsNs=",
  },
  "Hide Buckets": {
    val: "Hide Buckets",
    translated: false,
    src: ["src/mainprocess/menu.ts line 359"],
  ...
  "Animation:": {
    val: "Animation:",
    translated: false,
    src: ["src/wwwroot/misc/preferences.tsx line 60"],
  ...
  "(Restart Buckets for the change to take effect.)": {
    ...
    translated: false,
    src: ["src/wwwroot/misc/preferences.tsx line 73"],
  ...
  "EXPERIMENTAL Buckets Macro Maker": {
    ...
    translated: false,
    src: ["src/wwwroot/record/record.html line 0","src/wwwroot/record/record.tsx line 833"],
    h: "NZPVXQ+Dw1vv0fLXY+Z4R1KiEkXjDZtSmY3tVz5L1VI=",
  },
  "navigatestep": {
    val: (url) => `Go to ${url}`,
    translated: false,
    src: ["src/wwwroot/record/record.tsx line 353"],
    h: "nI/J4GfYlL6BgRZRSiPFfA5o7ASdx2VVYW6x3vgCuKE=",
  },
  "off": {
    val: "off",
    translated: false,
    src: ["src/wwwroot/record/record.tsx line 360"],
  ...
  "Open YNAB4 File": {
    val: "Open YNAB4 File",
    translated: false,
    src: ["src/ynab.ts line 560"],
    h: "BrKgvN0SgW410a7e11V3gP+FgW67iTGIY+o/cKI1Ftk=",
  },
  "Error importing": {
    val: "Error importing",
    translated: false,
    src: ["src/ynab.ts line 575"],
