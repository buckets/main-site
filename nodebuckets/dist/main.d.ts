...
declare type SqliteDataType = "Null" | "Int" | "Float" | "Text" | "Blob";
declare type SqliteParam = string | number | null;
interface SqliteParamObj {
    [k: string]: SqliteParam;
}
declare type SqliteParams = SqliteParam[] | SqliteParamObj;
export declare function db_all(bf_id: number, query: string, params: SqliteParams): {
