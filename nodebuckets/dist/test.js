    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    _a.sent();
                    return [4 /*yield*/, dotest("db_all", function () { return __awaiter(_this, void 0, void 0, function () {
                            var _a, _b, _c;
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, dotest("db_all error", function () { return __awaiter(_this, void 0, void 0, function () {
                            var err_1;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        err_1 = _a.sent();
                                        console.log("Expecting this error:", err_1);
                ...
                case 7:
                    _a.sent();
                    return [4 /*yield*/, dotest("db_run", function () { return __awaiter(_this, void 0, void 0, function () {
                            var res;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
