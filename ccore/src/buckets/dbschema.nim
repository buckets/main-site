...
let migrations* = [
    ...
    (name: "triggercontrol-andundo", fn: sqlList([
      # Drop them all
    ...
    (name: "postedtolocal", fn: sqlList([
        # no one is likely to be using this version
    ])),
    (name: "nullamounttriggers", fn: sqlList([
    # Drop them all
    """DROP TRIGGER update_account_balance_insert""",
    """DROP TRIGGER update_account_balance_delete""",
    """DROP TRIGGER update_account_balance_update""",
